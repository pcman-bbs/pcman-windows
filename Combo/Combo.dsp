...
OutDir=.\Release
SOURCE="$(InputPath)"
PreLink_Cmds=$(OutDir)\BuildMenu.exe $(OutDir)\PCMan Combo\Config
...
# ADD CPP /nologo /MTd /W3 /Gm /GX- /ZI /Od /I "..\SimpXmlParser" /D "_DEBUG" /D "_COMBO_" /D "BUILD_UI" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /FD /GZ /c
